...
public class Hotel {
	...
	public Hotel (String name) {
		...
		this.room1 = new PricedRoom(101, 60.00, 2.00);
	...
	public Bill getBill (String guestName, int nightsStayed, StringPrinter printer) {
		Bill bill = new Bill(printer);

		if (this.room1.getGuest() != null && this.room1.getGuest().getName() == guestName && this.room1 instanceof PricedRoom) {
			bill.addItem((PricedRoom) this.room1);
			bill.addItem((PricedSafe) this.room1.getSafe());

			return bill;
		}

		if (this.room2.getGuest() != null && this.room2.getGuest().getName() == guestName && this.room2 instanceof PricedRoom) {
			bill.addItem((PricedRoom) this.room2);
			bill.addItem((PricedSafe) this.room2.getSafe());
